...
Route::delete('/Admin/loaisanpham/{id}',[LoaiSanPhamController::class,'destroy'])->name('Admin/loaisanpham.index');
...
Route::delete('/Admin/sanpham/{id}',[SanPhamController::class,'destroy'])->name('Admin/sanpham.index');

//KhachHang
Route::get('/Account',[App\Http\Controllers\KhachHangController::class,'index'])->name('KhachHang.index');
Route::post('/Account/DangNhap',[App\Http\Controllers\KhachHangController::class,'login'])->name('KhachHang.login');
Route::post('/Account/DangKy',[App\Http\Controllers\KhachHangController::class,'register'])->name('KhachHang.register');
//Giỏ hàng
